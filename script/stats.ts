...
console.log("Fetching GitHub releases for sst/opensploit...\n")
...
console.log("Fetching npm all-time downloads for opensploit-ai...\n")
const npmDownloads = await fetchNpmDownloads("opensploit-ai")
