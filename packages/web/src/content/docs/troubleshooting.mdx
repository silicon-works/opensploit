...
To debug any issues with OpenSploit, you can check the logs or the session data
...
If you're experiencing issues with OpenSploit:

1. **Report issues on GitHub**

   The best way to report bugs or request features is through our GitHub repository:

   [**github.com/silicon-works/opensploit/issues**](https://github.com/silicon-works/opensploit/issues)
...
2. **Join our Discord**
   ...
   [**opensploit.ai/discord**](https://opensploit.ai/discord)
