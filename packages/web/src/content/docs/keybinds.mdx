...
OpenSploit has a list of keybinds that you can customize through the OpenSploit config.
...
OpenSploit uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
