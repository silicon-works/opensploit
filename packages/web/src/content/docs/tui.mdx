---
title: TUI
description: Using the OpenSploit terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenSploit provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running OpenSploit starts the TUI for the current directory.
...
When using the OpenSploit TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to OpenSploit. Allows you to select from available providers and add their API keys.
...
Exit OpenSploit. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your OpenSploit config file.
