---
title: LSP Servers
description: OpenSploit integrates with your LSP servers.
---

OpenSploit integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

OpenSploit comes with several built-in LSP servers for popular languages:
...
:::note
You can disable automatic LSP server downloads by setting the `OPENSPLOIT_DISABLE_LSP_DOWNLOAD` environment variable to `true`.
:::
