---
title: Share
description: Share your OpenSploit conversations.
---

OpenSploit's share feature allows you to create public links to your OpenSploit conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OpenSploit:
...
OpenSploit supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OpenSploit uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `opensploit.json` in your project and check into Git.
