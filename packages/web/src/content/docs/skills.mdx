...
Agent skills let OpenSploit discover reusable instructions from your repo or home directory.
...
OpenSploit searches these locations:
...
For project-local paths, OpenSploit walks up from your current working directory until it reaches the git worktree.
...
OpenSploit adds an `<available_skills>` XML block to the system prompt.
