...
Configure modes in your `opensploit.json` config file:
...
- Global: `~/.config/opensploit/mode/`
- Project: `.opencode/mode/`

```markdown title="~/.config/opensploit/mode/review.md"
---
model: anthropic/claude-sonnet-4-20250514
temperature: 0.1
tools:
...
Create mode files in `.opencode/mode/` for project-specific modes or `~/.config/opensploit/mode/` for global modes:
...
```markdown title="~/.config/opensploit/mode/refactor.md"
---
model: anthropic/claude-sonnet-4-20250514
temperature: 0.2
tools:
