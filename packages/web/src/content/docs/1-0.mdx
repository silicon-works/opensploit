...
description: What's new in OpenSploit 1.0.
---

OpenSploit 1.0 is a complete rewrite of the TUI.
...
version. However some older versions of OpenSploit always grab latest.
