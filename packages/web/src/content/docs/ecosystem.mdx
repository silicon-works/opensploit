---
title: Ecosystem
description: Projects and integrations built with OpenSploit.
---

A collection of community projects built on OpenSploit.

:::note
Want to add your OpenSploit related project to this list? Submit a PR.
:::
...
| [opencode-skills](https://github.com/malhashemi/opencode-skills)                                  | Manage and organize OpenSploit skills and capabilities                                          |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                               | Track OpenSploit usage with Wakatime                                                            |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                           | AI-powered automatic Zellij session naming based on OpenSploit context                          |
...
| Name                                                                                       | Description                                                     |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control OpenSploit sessions, built on the SDK      |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim plugin for editor-aware prompts, built on the API        |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for OpenSploit over Tailscale/VPN             |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building OpenSploit plugins                          |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for opencode - a terminal-based AI coding agent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using OpenSploit via @opencode-ai/sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for OpenSploit            |
