...
const TIPS = [
  ...
  "Place settings in {highlight}~/.config/opensploit/opensploit.json{/highlight} for global config",
  ...
  "OpenSploit auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "OpenSploit auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "OpenSploit uses LSP servers for intelligent code analysis",
  "Create {highlight}.ts{/highlight} files in {highlight}.opensploit/tool/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.opensploit/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent OpenSploit from reading sensitive files",
  "Use {highlight}opensploit run{/highlight} for non-interactive scripting",
  "Use {highlight}opensploit run --continue{/highlight} to resume the last session",
  "Use {highlight}opensploit run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opensploit serve{/highlight} for headless API access to OpenSploit",
  "Use {highlight}opensploit run --attach{/highlight} to connect to a running server",
  "Run {highlight}opensploit upgrade{/highlight} to update to the latest version",
  "Run {highlight}opensploit auth list{/highlight} to see all configured providers",
  "Run {highlight}opensploit agent create{/highlight} for guided agent creation",
  "Use {highlight}/opensploit{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}opensploit github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/opensploit fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/opensploit{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with OpenSploit Zen for curated, tested models",
