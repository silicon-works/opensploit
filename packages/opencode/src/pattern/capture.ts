...
import type { EngagementState, StateSnapshot } from "../tool/engagement-state"
import { loadEngagementState, getStateSnapshots } from "../tool/engagement-state"
...
const log = Log.create({ service: "pattern.capture" })
