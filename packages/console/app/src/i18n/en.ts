export const dict = {
  ...
  "app.meta.description": "OpenSploit - The open source offensive security agent.",
  ...
  "temp.logoLightAlt": "opensploit logo light",
  "temp.logoDarkAlt": "opensploit logo dark",
  ...
  "go.title": "OpenSploit Go | Low cost coding models for everyone",
  "go.meta.description":
  ...
  "go.testimonials.handle": "@OpenSploit",
  ...
  "go.problem.body":
    "We're focused on bringing the OpenSploit experience to as many people as possible. OpenSploit Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with OpenSploit or any agent.",
  ...
  "go.faq.q1": "What is OpenSploit Go?",
  "go.faq.a1":
  ...
  "workspace.lite.subscription.message": "You are subscribed to OpenSploit Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "OpenSploit Go" as the provider in your opensploit configuration to use Go models.',
  "workspace.lite.black.message":
    "You're currently subscribed to OpenSploit Black or on the waitlist. Please unsubscribe first if you'd like to switch to Go.",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to OpenSploit Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "OpenSploit Go starts at {{price}}, then $10/month, and provides reliable access to popular open coding models with generous usage limits.",
