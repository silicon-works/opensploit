...
export namespace Agent {
  ...
  const state = Instance.state(async () => {
    ...
    const pentestBashPermissions = {
      ...
      "winpeas*": "deny",
      "sudo *": "deny",
      // Code execution requires user approval (allows adaptive behavior when tools are insufficient)
      // User can approve scripts for retry logic, custom payloads, or edge cases
      // Security tools above remain "deny" because they must use MCP for isolation/logging
      "gcc*": "ask",
      "g++*": "ask",
      "cc *": "ask",
      "clang*": "ask",
      "make*": "ask",
      "cmake*": "ask",
      "./*": "ask", // executing local binaries requires approval
      "sh *": "ask",
      "sh -c*": "ask",
      "bash *": "ask",
      "bash -c*": "ask",
